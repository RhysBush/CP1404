...
def run_tests():
    ...
    # The following test should fail if asserted:
    assert not test_car.fuel == 11
...
def convert_phrase_to_sentence(phrase):
    ...
    'It is an ex parrot.'
    >>> convert_phrase_to_sentence('Listen to Frogstomp by Silverchair')
    'Listen to frogstomp by silverchair.'
    """
